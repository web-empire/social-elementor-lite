				...
				<div class="postbox">
					...
					<div class="inside">
						...
						<?php
							...
							$contribute_suggession_text = apply_filters( 'contribute_suggession_text', __( 'Share Your Suggessions »', 'social-elementor' ) );
				...
				<div id="side-sortables">
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<a href='<?php echo esc_url( $kb_url ); ?> ' target="_blank" rel="noopener"><?php esc_attr_e( 'Visit Knowledge Base »', 'social-elementor' ); ?></a>
						</div>
					</div>
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<a href='<?php echo esc_url( $code_doc_url ); ?> ' target="_blank" rel="noopener"><?php esc_attr_e( 'Refer the Documentation »', 'social-elementor' ); ?></a>
						</div>
					</div>
						...
						<div class="postbox">
							...
							<div class="inside">
								...
								<?php
									...
									$social_support_link_text = apply_filters( 'social_support_link_text', __( 'Submit a Ticket »', 'social-elementor' ) );
