<?php
/**
 * Social Elementor Blog Base Class.
 *
...
use SocialElementor\Modules\Blog\Skins;
...
class Blog extends Blog_Base {
	...
	public function get_name() {
		return parent::get_widget_slug( 'Blog' );
	}
	...
	public function get_title() {
		return parent::get_widget_title( 'Blog' );
	}
	...
	public function get_keywords() {
		return parent::get_widget_keywords( 'Blog' );
	}
	...
	public static function get_query_posts( $control_id, $settings ) {
		...
		return apply_filters( 'social_blog_posts_query_args', $query_args, $settings );
	}
